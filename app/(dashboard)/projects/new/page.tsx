    ...
    <div className="max-w-2xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create a new project to start building your code tutorial
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Private: Only you can see it. Unlisted: Anyone with the link can see it. Public: Everyone can see it.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
